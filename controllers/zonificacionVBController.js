...
export const filterZonificacionVBByIdCreator = async (request, response) => {
...
export const updateZonificacionVB = async (request, response) => {
    ...
    const id = request.params.id;
    const idVB = request.body.idVistoBueno;
     try {
